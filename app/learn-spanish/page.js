  ...
  const links = [
    {
      ...
      desc: "Books built around subtitles, real dialogue, and binge-watching routines.",
    ...
    },
    {
      ...
      desc: "Learn the words that show up constantly in real conversations and TV.",
      href: amazonSearchUrl("spanish frequency dictionary"),
      note: "Amazon search results (tagged: spanishtvshow-20)",
    },
    {
      title: "Spanish grammar (simple, not painful)",
      desc: "A clean reference so you stop guessing and start speaking correctly.",
      href: amazonSearchUrl("spanish grammar made easy"),
      note: "Amazon search results (tagged: spanishtvshow-20)",
    },
    {
      title: "Spanish graded readers (Kindle + paperbacks)",
      desc: "Reading + TV is the fastest combo for comprehension.",
      href: amazonSearchUrl("spanish graded readers adults"),
      note: "Amazon search results (tagged: spanishtvshow-20)",
    },
    {
      title: "Headphones for clear dialogue",
      desc: "Clear dialogue = faster comprehension. People buy this.",
      href: amazonSearchUrl("headphones clear dialogue tv"),
      note: "Amazon search results (tagged: spanishtvshow-20)",
    },
    {
      title: "Language learning notebook (phrase mining)",
      desc: "Write phrases you hear, reuse them, and your Spanish jumps fast.",
  ...
  return (
    <main className="max-w-7xl mx-auto px-6 py-12 text-white">
      ...
      <p className="mt-4 text-gray-300 max-w-3xl leading-relaxed">
        Tools that help you learn faster while binge-watching Spanish shows.
      </p>
