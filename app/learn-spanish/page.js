...
// Amazon “money-maker” links (search links convert better than random products)
const amazonPicks = [
  {
    title: "Spanish learning books that don’t suck",
    blurb:
      "Books that teach Spanish with dialogue, slang, and real conversation — great while bingeing shows.",
    href: amazonSearchUrl("learn spanish with tv books"),
  },
  {
    title: "Spanish-English dictionary (fast + useful)",
    blurb:
      "Pocket dictionaries and reference books (good for quick checks when subtitles fly).",
    href: amazonSearchUrl("spanish english dictionary"),
  },
  {
    title: "Spanish grammar workbook (actually practical)",
    blurb:
      "Workbooks for the stuff TV won’t fully teach (verb tenses, sentence structure).",
    href: amazonSearchUrl("spanish grammar workbook"),
  },
  {
    title: "Notebook / study supplies",
    blurb:
      "Because writing down phrases is still undefeated.",
    href: amazonSearchUrl("study notebook for language learning"),
  },
];
    ...
    <div className="bg-dark min-h-screen">
      <section className="max-w-7xl mx-auto px-6 py-16">
        ...
        <p className="text-sm text-gray-400 mb-6 max-w-2xl">
          These tools can turn any Spanish show into a full language course.
        </p>
        ...
        {/* Amazon section */}
        <h2 className="text-2xl font-bold mb-4">Stuff people actually buy (Amazon)</h2>
        <p className="text-sm text-gray-400 mb-6 max-w-2xl">
          Quick picks that pair well with learning from shows.
        </p>
